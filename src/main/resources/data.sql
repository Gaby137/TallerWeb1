INSERT INTO Usuario(id, email, password, rol, activo, puntos) VALUES(1, 'test@unlam.edu.ar', 'test', 'ADMIN', true, 0);
INSERT INTO Usuario(id, email, password, rol, activo, puntos) VALUES(2, 'test2@unlam.edu.ar', 'test2', 'ADMIN', true, 0);
INSERT INTO Usuario(id, email, password, rol, activo, puntos) VALUES(3, 'test3@unlam.edu.ar', 'test3', 'ADMIN', true, 0);
