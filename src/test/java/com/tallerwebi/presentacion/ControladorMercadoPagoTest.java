...
public class ControladorMercadoPagoTest {
    ...
    public void queSeRedireccioneCorrectamente(){
        String pack = "oro";
        Usuario usuario = new Usuario("Matias","Godoy",0,"prueba@asd.com","1234", Rol.USUARIO,true,"",0.00,0.00, "asdasd", new Date(), new Date());
    ...
    public void queSiElPagoDeCualquierPackFallaNoSeSumenPuntos(){
        ...
        Usuario usuario = new Usuario("Matias","Godoy",PUNTOS_ESPERADOS,"prueba@asd.com","1234", Rol.USUARIO,true,"",0.00,0.00, "asdasd", new Date(), new Date());
        when(sessionMock.getAttribute("usuario")).thenReturn(usuario);
